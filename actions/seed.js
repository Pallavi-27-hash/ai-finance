...
const CATEGORIES = {
  INCOME: [
    { name: "salary", range: [5000, 8000000] },
    { name: "freelance", range: [1000, 3000000] },
    { name: "investments", range: [500, 200000] },
    { name: "other-income", range: [1000, 1000] },
  ],
  EXPENSE: [
